...
public class TelaRelatorioChamado extends JFrame{
	...
	public TelaRelatorioChamado(ControleChamados c){	
		super("RelatXrio de chamados encerrados");
		this.CC = c;
	...
	private void inicializar(){
		...
		lstProb.addItem("Problema de Rede/ConexXo");
		...
		btEmitir = new JButton("Emitir relatXrios");
	...
	private class GE implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getActionCommand().equals(btEmitir.getText())){
				...
				if(relatorio.equals("")){ incluirTexto("NXo hX chamados deste tipo de problema para exibir");
				}else{
